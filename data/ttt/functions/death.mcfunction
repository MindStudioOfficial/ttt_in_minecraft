...
execute at @e[tag=sign] if entity @a[scores={tod=1},team=innocent] run data modify block ~ ~ ~ Text2 set value '{"text":"conf_innocent"}'
execute at @e[tag=sign] if entity @a[scores={tod=1},team=traitor] run data modify block ~ ~ ~ Text2 set value '{"text":"conf_traitor"}'
execute at @e[tag=sign] if entity @a[scores={tod=1},team=detective] run data modify block ~ ~ ~ Text2 set value '{"text":"conf_detective"}'

execute at @a[scores={tod=1}] run summon armor_stand ~ ~-1.25 ~ {DisabledSlots:4144959,CustomNameVisible:0b,Tags:["head"],HandItems:[{id:"minecraft:red_tulip",Count:1b},{}],ArmorItems:[{},{},{id:"minecraft:leather_chestplate",Count:1b},{id:"minecraft:zombie_head",Count:1b}],Invisible:0b,NoGravity:1b,NoBasePlate:1b,ShowArms:1b,Pose:{Body:[278f,0f,0f],Head:[317f,0f,0f],LeftArm:[270f,0f,0f],RightArm:[270f,0f,0f],LeftLeg:[270f,0f,0f],RightLeg:[270f,0f,0f]}}
execute at @e[tag=sign] run data modify entity @e[tag=head,limit=1,sort=nearest] CustomName set from block ~ ~ ~ Text1
#execute at @e[tag=sign] run data modify entity @e[tag=head,limit=1,sort=nearest] Team set from block ~ ~ ~ Text2
execute at @a[scores={tod=1}] run summon armor_stand ~ ~-.625 ~.25 {DisabledSlots:4144959,Tags:["feet"],ArmorItems:[{id:"minecraft:leather_boots",Count:1b},{},{},{}],Invisible:1b,NoGravity:1b,NoBasePlate:1b,Pose:{Body:[180f,0f,0f],LeftLeg:[270f,0f,0f],RightLeg:[270f,0f,0f]}}
