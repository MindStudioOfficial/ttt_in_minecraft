#* join confirmed team to copy the colored name to the corpse
...
#* summon corpse
execute at @a[scores={tod=1}] run summon armor_stand ~ ~-1.25 ~ {DisabledSlots: 4144959, CustomNameVisible: 0b, Tags: ["head", "unnamed", "corpse"], HandItems: [{id: "minecraft:red_tulip", Count: 1b}, {}], ArmorItems: [{}, {}, {id: "minecraft:leather_chestplate", Count: 1b}, {id: "minecraft:skeleton_skull", Count: 1b}], Invisible: 0b, NoGravity: 1b, NoBasePlate: 1b, ShowArms: 1b, Pose: {Body: [278f, 0f, 0f], Head: [317f, 0f, 0f], LeftArm: [270f, 0f, 0f], RightArm: [270f, 0f, 0f], LeftLeg: [270f, 0f, 0f], RightLeg: [270f, 0f, 0f]}}
...
#* rejoin unconfirmed team to not show the colored name in the player list
