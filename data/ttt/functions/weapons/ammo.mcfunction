...
#rifle
execute as @a[nbt={SelectedItem:{tag:{CustomModelData:1}}}] run scoreboard players operation @s currentammo = @s c_ammo_rifle
execute as @a[nbt={SelectedItem:{tag:{CustomModelData:1}}}] run scoreboard players operation @s totalammo = @s t_ammo_rifle
#reload
