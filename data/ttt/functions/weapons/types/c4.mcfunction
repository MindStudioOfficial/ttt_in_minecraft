...
execute as @e[tag=c4,scores={c4time=..0}] at @s run execute at @a[distance=0..5] run damage @p 100 generic
execute as @e[tag=c4,scores={c4time=..0}] at @s run execute at @a[distance=5..10] run damage @p 18 generic
execute as @e[tag=c4,scores={c4time=..0}] at @s run execute at @a[distance=10..20] run damage @p 5 generic
