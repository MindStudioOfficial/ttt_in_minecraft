...
#* reset reload delay if ammo present in case switched from other reloading weapon
execute as @a[predicate=ttt:alive_holding_rifle] if score @s ammo_loaded_rifle matches 1.. if score @s reloaddelay matches 1.. run scoreboard players set @s reloaddelay 0
...
#* reset reload delay if ammo present in case switched from other reloading weapon
execute as @a[predicate=ttt:alive_holding_pistol] if score @s ammo_loaded_pistol matches 1.. if score @s reloaddelay matches 1.. run scoreboard players set @s reloaddelay 0
#* if reload delay reached move ammo from mag to loaded
...
#* reset reload delay if ammo present in case switched from other reloading weapon
execute as @a[predicate=ttt:alive_holding_mp5] if score @s ammo_loaded_mp5 matches 1.. if score @s reloaddelay matches 1.. run scoreboard players set @s reloaddelay 0
#* if reload delay reached move ammo from mag to loaded
